...
public class Map extends AppCompatActivity implements MapView.CurrentLocationEventListener {
    ...
    public void onCurrentLocationDeviceHeadingUpdate(MapView mapViewm ,float v){
    ...
    public void onReversGeoCoderFoundAddress(MapReverseGeoCoder mapReverseGeoCoder, String s){
